/**
 * UNIFIED DOD CONSTANTS
 * 
 * Shared Data-Oriented Design constants for Client/Server entity parity.
 * These constants define buffer sizes, physics values, and entity type constraints.
 * 
 * CRITICAL: Changes here must maintain Client/Server CRC32 determinism!
 * Any byte-offset or component layout change breaks determinism.
 */

/**
 * PHYSICS CONSTANTS - Client/Server Parity
 * Single source of truth for movement, gravity, and collision values.
...
/**
 * Entity Type Constants - Server Authority
 * Defines which entity types are allowed in snapshots and game logic.
 */
export const SNAPSHOT_ALLOWED_ENTITY_TYPES = new Set(['player']);

/**
 * Validate constants are reasonable (used in both environments)
 */
